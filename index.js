let arrayProductos = [
    {id:1, nombre: "toteCorazonRojo", precio: 4500, descripcion:"Tote Corazon Rojo: Chicas super poderosas", imagen: "../imagenes/tote-corazon-rojo.jpg", color: "Naranja"},
    {id:2, nombre: "toteCerezas", precio: 3500, descripcion:"Tote de Cerezas", imagen: "../imagenes/tote-fr.jpg", color: "Rosa"},
    {id:3, nombre: "toteCorazones", precio: 3500, descripcion:"Tote de Corazones coloridos", imagen: "../imagenes/tote-corazones.jpg", color: "Verde"},
    {id:4, nombre: "toteDiscoGroovi", precio: 4500, descripcion:"Tote con Esfera Disco", imagen: "../imagenes/tote-disco.jpg", color: "Violeta"},
    {id:5, nombre: "toteCorazonNaranja", precio: 4500, descripcion:"Tote Corazon Rojo: Chicas super poderosas", imagen: "../imagenes/tote-corazon-naranja.jpg", color: "Naranja"},
    {id:6, nombre: "totePsicodelica", precio: 4500, descripcion:"Tote Psicodelica con lineas y curvas asimétricas", imagen: "../imagenes/tote-psicod.jpg", color: "Violeta"},
]
let carrito = [];
...
let notificacionEliminarSel = document.getElementById('notificacionEliminarSel')
...
let elemento = arrayProductos.find(element => element.id === parseInt(e.target.id[12]));
...
function actualizarProductos(){
            ...
            let botonEliminarSelec = document.getElementById(`eliminarProductoSelec${item.id}`)
            ...
            botonEliminarSelec.addEventListener('click', (e)=>{
                let carritoActualizado = traerCarrito.filter(i => i.id != parseInt(e.target.id[21]));
                localStorage.setItem('carritoNuevo',JSON.stringify(carritoActualizado));
